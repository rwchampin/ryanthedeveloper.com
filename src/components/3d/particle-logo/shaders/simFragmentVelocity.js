...
float maxDistance = 0.26;
if (mouseDistance < maxDistance) {
    float dx = position.x - uMouse.x;
    float dy = position.y - uMouse.y;
    ...
    velocity += toMouse * 0.01;
    // velocity += direction * (1.0 - mouseDistance / maxDistance) * 0.01;
} else {
    // When not interacting, quicklu return to original position
    vec3 toOriginal = original - position;
    // velocity += toOriginal * 0.01;
    velocity += toOriginal * 0.0001;
}
