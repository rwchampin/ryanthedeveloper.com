...
import { useGLTF, 
    Center,
    ScreenSpace,
SoftShadows, Html, CameraControls } from '@react-three/drei'
...
export default function Grace() {
  return (
    <Canvas shadows="basic" eventSource={document.getElementById('root')} eventPrefix="client" camera={{ position: [0, 0, 1], fov: 45 }}>
...
function Model(props) {
  ...
  const { nodes }:any = useGLTF(LOGO_URL)
  ...
  return (
    <group ref={group} {...props}>
            ...
            <ScreenSpace depth={1}>
      <mesh castShadow receiveShadow geometry={nodes.Scene.children[0].geometry} rotation={[Math.PI / 2, 0, 0]}  dispose={null}>
        <meshLambertMaterial color="#404044" />
      </mesh>
      </ScreenSpace>
     
      <spotLight angle={0.5} penumbra={0.5} ref={light} castShadow intensity={1} shadow-mapSize={1024} shadow-bias={-0.001}>
