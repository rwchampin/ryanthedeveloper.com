...
import { mat4, vec3, quat4 } from 'gl-matrix';

class SceneRotation {
  constructor(listenerTarget = document) {
    this._z = 0;
    this._mouseZ = 0;
    this._preZ = 0;
    this._isRotateZ = 0;
  ...
  _onMouseDown(e) {
    ...
    const mouse = SceneRotation.getMousePos(e);
    const tempRotation = quat4.create(this._rotation);
  ...
  _onMouseMove(e) {
    this.mouse = SceneRotation.getMousePos(e);
  }
