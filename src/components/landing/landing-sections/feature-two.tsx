    ...
    <div className="relative flex w-full flex-col overflow-hidden bg-cover">
        ...
        <div className="flex max-w-[1170px] flex-col-reverse items-center justify-between gap-[70px] px-5 md:px-10 lg:flex-row lg:items-start xl:px-0">
          ...
          <div className="my-auto flex max-w-full flex-col items-center lg:items-start">
            ...
            <h1 className="mb-5 w-full max-w-full text-center text-[28px] font-extrabold leading-10 text-zinc-950 dark:text-white md:w-[70%] md:max-w-[unset] md:text-[36px] md:leading-[50px] lg:w-full lg:text-left xl:text-[42px] xl:leading-[52px]">
              Advanced Platform for your Startup Web App
            </h1>
            <p className="mb-8 w-full text-center text-base font-normal leading-8 text-zinc-950 dark:text-zinc-400 md:px-14 lg:w-[97%] lg:px-0 lg:text-left">
