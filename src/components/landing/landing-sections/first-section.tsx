...
export default function FirstSection() {
 ...
 const numbersdark='https://placehold.co/600x400'
  const numberslight='https://placehold.co/600x400'
  return (
      ...
      <div className="flex max-w-[unset] flex-col px-5 md:px-10 xl:px-0">
        <div className="mb-10 flex w-[stretch] flex-col">
          <div className="mx-auto flex flex-col items-center text-center">
            <Badge
              variant="outline"
              className="mx-auto mb-2.5 w-max px-4 py-2 text-zinc-950 dark:border-none dark:bg-zinc-800 dark:text-white"
            >
              BEST AI NEXTJS BOILERPLATE
            </Badge>
            <h1 className="mx-auto mb-5 w-full text-center text-3xl font-extrabold text-zinc-950 dark:text-white md:mb-8 md:w-[100%] md:text-[48px] md:leading-[60px] lg:w-[90%] xl:w-[70%] xl:text-6xl xl:leading-[70px] 2xl:w-[60%]">
              Your All-in-One @shadcn/ui NextJS SaaS Boilerplate
            </h1>
            <p className="w-[96%] text-base font-normal leading-8 text-zinc-950 dark:text-zinc-400 md:w-[80%] md:text-base md:leading-8 lg:w-[80%] xl:w-[54%] xl:text-lg xl:leading-[32px] 2xl:text-lg 2xl:leading-[32px]">
        ...
        <div className="mx-auto mt-5 flex min-h-[760px] w-[1170px] max-w-full flex-wrap items-center justify-center gap-5 md:flex-row lg:flex-nowrap">
          <div className="md:w-[75%] lg:w-[50%]">
            <Card className="mb-5 flex w-full flex-col items-center justify-center px-8 py-10 text-center dark:border-zinc-800 md:px-14 xl:px-32 xl:py-16">
              <h2 className="mb-4 text-8xl font-extrabold text-zinc-950 dark:text-white">
                50+
              </h2>
              <h4 className="mb-4 text-lg font-semibold text-zinc-950 dark:text-white">
                Components & Elements
              </h4>
              <p className="text-base font-normal text-zinc-950 dark:text-zinc-400">
          ...
          <Card className="flex h-full flex-col items-center justify-stretch overflow-hidden text-center dark:border-zinc-800 md:w-[75%] lg:w-[50%]">
            <div className="mb-auto h-full px-6 pt-8 md:px-14 xl:px-32 xl:pt-16">
              ...
              <p className="mb-6 text-base font-normal text-zinc-950 dark:text-zinc-400">
        ...
        <div className="mx-auto mt-20 flex flex-col items-center justify-center md:flex-row">
          <a className="mb-5 md:mb-0 md:me-5" href="/dashboard/main">
        ...
        <p className="mx-auto mt-4 px-12 text-center text-xs font-normal text-zinc-950 dark:text-zinc-400 md:px-0 md:text-start">
