...
export function FAQ() {
  return (
   ...
   rounded-xl bg-[linear-gradient(180deg,_#FFF_0%,_#F4F4F5_100%)] px-2 dark:bg-[linear-gradient(180deg,_rgba(255,_255,_255,_0.00)_0%,_rgba(255,_255,_255,_0.10)_100%)] md:mt-[90px]
   md:rounded-3xl
   md:px-0 lg:mt-[103px] 2xl:w-[94vw]"
    ...
    >
      <div className="mx-auto mb-10 flex max-w-[90%] flex-col items-center justify-center xl:max-w-[62%]">
        ...
        <h1 className="mx-auto mb-5 text-center text-3xl font-extrabold text-zinc-950 dark:text-white md:text-5xl">
          Frequently asked questions
        </h1>
        <p className="3xl:max-w-[56%] mx-auto mb-8 max-w-full text-center text-base font-normal leading-8 text-zinc-950 dark:text-zinc-400 md:max-w-[80%] md:text-lg md:leading-8 2xl:max-w-[66%]">
