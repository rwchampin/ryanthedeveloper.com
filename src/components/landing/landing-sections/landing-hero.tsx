...
// import herodark from '@public/dark/hero/hero-image.png';
// import herolight from '@public/light/hero/hero-image.png';
...
const LandingHero = () => {
  ...
  return (
    <div
      className="relative mx-auto mt-12 flex w-[96vw] flex-col content-center items-center rounded-xl 
      ...
      <div className="flex w-full">
        <div className="3xl:pt-[200px] mb-0 flex w-[stretch] max-w-full flex-row content-center items-center justify-between pt-20 lg:pt-[120px]">
          <div className="mx-auto flex w-full flex-col text-center">
            <Badge
              variant="outline"
              className="mx-auto w-max px-4 py-2 text-zinc-950 dark:border-none dark:bg-zinc-800 dark:text-white"
            >
              Introducing: Horizon UI Boilerplate x shadcn/ui
            </Badge>
            <h1 className="3xl:text-6xl z-[40] mx-auto mb-6 mt-4 max-w-[94%] text-3xl font-bold leading-[36px] text-transparent text-zinc-950 dark:text-white md:max-w-[70%] md:text-[50px] md:leading-[60px] lg:max-w-[76%] lg:text-[50px] lg:leading-[68px] xl:max-w-[60%] 2xl:max-w-[48%] 2xl:text-[50px] 2xl:leading-[68px]">
              Launch your startup project 10X faster in a few moments
            </h1>
            <h5 className="mb-8 w-[96%] self-center text-base font-normal leading-8 text-zinc-950 dark:text-zinc-400 md:mb-10 md:w-[82%] lg:w-[62%] xl:w-[50%] xl:text-lg xl:leading-[32px] 2xl:w-[44%] 2xl:text-lg 2xl:leading-[32px]">
            ...
            <div className="mx-auto flex items-center justify-center">
              <a className="me-2 md:me-5" href="/dashboard/main">
