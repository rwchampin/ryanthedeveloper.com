      ...
      <div className="flex max-w-[1170px] flex-col items-center justify-center px-0 md:px-10 xl:px-0">
        <div className="flex w-[stretch] flex-col">
          <div className="mx-auto flex flex-col items-center text-center">
            ...
            <h1 className="mx-auto text-center text-3xl font-extrabold leading-[38px] text-zinc-950 dark:text-white md:text-[48px] md:leading-[60px] xl:text-6xl xl:leading-[70px]">
              How it works?
            </h1>
          </div>
        </div>
        <div className="flex w-[86%] max-w-full flex-col items-center justify-center pt-10 md:w-[76%] md:pt-[60px] lg:w-[100%] lg:flex-row">
          <Card className="lg-0 mb-[50px] mr-0 flex flex-col p-6 dark:border-zinc-800 lg:mb-0 lg:mr-4">
            <h5 className="mb-3 text-center text-base font-semibold text-zinc-950 dark:text-white md:text-left xl:text-lg">
              Step 1: This is an example
            </h5>
            <p className="w-[98%] text-center text-base font-normal text-zinc-950 dark:text-zinc-400 md:text-left md:text-base md:leading-8">
          ...
          <Card className="lg-0 mb-[50px] mr-0 flex flex-col p-6 dark:border-zinc-800 lg:mb-0 lg:mr-4">
            ...
            <p className="w-[98%] text-center text-base font-normal leading-7 text-zinc-950 dark:text-zinc-400 md:text-left md:text-base md:leading-8">
