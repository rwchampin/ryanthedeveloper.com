...
function SidebarHorizon(props: {   [x: string]: any }) {
  const context = useContext(ConfiguratorContext);
  // const {  open, setOpen, variant, setHovered, hovered } = context;
  // const { mini,
  //     setMini,
    return null;
  //  } = context;
  ...
  //         ? 'w-[285px]'
  //         : 'w-[285px] xl:!w-[120px]'
  //     } duration-175 linear   !z-50 min-h-full transition-all md:!z-50 lg:!z-50 xl:!z-0 ${
