...
import SolidSubtleAlert from '@/components/shared/main/others/notifications/SolidSubtleAlert';
import SolidSubtleMultiAlert from '@/components/shared/main/others/notifications/SolidSubtleMultiAlert';
const Notification = () => {
  return (
