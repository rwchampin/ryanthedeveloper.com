'use client';
import MiniStatistics from '@/components/shared/main/account/application/MiniStatistics';
...
import ManagementTable from '@/components/shared/main/account/application/ManagementTable';
