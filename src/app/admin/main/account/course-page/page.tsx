...
import Completed from '@/components/shared/main/account/course-page/Completion';
import CourseInfo from '@/components/shared/main/account/course-page/CourseInfo';
