...
import Delete from '@/components/shared/main/ecommerce/settings-product/Delete';
import Details from '@/components/shared/main/ecommerce/settings-product/Details';
import DropeZone from '@/components/shared/main/ecommerce/settings-product/Dropzone';
import Information from '@/components/shared/main/ecommerce/settings-product/Info';
import Socials from '@/components/shared/main/ecommerce/settings-product/Socials';
