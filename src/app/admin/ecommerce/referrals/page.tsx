'use client';
import Earn from '@/components/shared/main/ecommerce/referrals/Earn';
import Invite from '@/components/shared/main/ecommerce/referrals/Invite';
// Assets
import {
  MdAttachMoney,
  MdCreditCard,
...
import ReferralsTable from '@/components/shared/main/ecommerce/referrals/ReferralsTable';
const Referrals = () => {
  return (
