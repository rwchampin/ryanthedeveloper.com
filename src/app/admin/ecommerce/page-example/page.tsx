'use client';
import PhotoGallery from '@/components/shared/main/ecommerce/page-example/PhotoGallery';
import ProductInfo from '@/components/shared/main/ecommerce/page-example/ProductInfo';
