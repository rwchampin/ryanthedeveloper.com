'use client';
import Banner from '@/components/shared/nfts/marketplace/Banner';
...
import HistoryItem from '@/components/shared/nfts/marketplace/HistoryItem';
import TopCreatorTable from '@/components/shared/nfts/marketplace/TableTopCreators';
